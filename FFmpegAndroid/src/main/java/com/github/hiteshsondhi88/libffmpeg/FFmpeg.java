...
public class FFmpeg implements FFmpegInterface {
    ...
    private FFmpegExecuteResponseHandler executeResponseHandler;
    ...
    public void removeExecuteResponseHandler() {
        if (ffmpegExecuteAsyncTask != null) {
            ffmpegExecuteAsyncTask.setFfmpegExecuteResponseHandler(null);
        }
    }

    public void removeExecuteLoadHandler() {
        if (ffmpegLoadLibraryAsyncTask != null)
            ffmpegLoadLibraryAsyncTask.setFfmpegLoadBinaryResponseHandler(null);
    }
