...
class FFmpegExecuteAsyncTask extends AsyncTask<Void, String, CommandResult> {
    ...
    public FFmpegExecuteResponseHandler getFfmpegExecuteResponseHandler() {
        return ffmpegExecuteResponseHandler;
    }

    public void setFfmpegExecuteResponseHandler(FFmpegExecuteResponseHandler ffmpegExecuteResponseHandler) {
        this.ffmpegExecuteResponseHandler = ffmpegExecuteResponseHandler;
    }
